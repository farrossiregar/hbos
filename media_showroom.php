				...
				<header class="navbar navbar-default navbar-static-top">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-right">
							...
							<li class="dropdown">
								<?php 
									if ($_SESSION['username']=='farros' ||  $_SESSION['leveluser']=='MNGR' ||  $_SESSION['leveluser']=='DRKSI'){
								?>
			...
			function cek_aktivitas(){
			    ...
			    $.ajax({
			        ...
			        success: function(total_pesan_pengecekan){
						if(leveluser == 'MNGR' || leveluser == 'DRKSI' || leveluser == 'mngr_bengkel' || leveluser == 'user'){
							...
							success: function(total_pesan_pengajuan){
								...
								$.ajax({
									...
									success: function(total_hasil_pengecekan){
										if(leveluser == 'CCO' || leveluser == 'HRD' || leveluser == 'user'){
										...
										console.log(jumlah_pengecekan_hasil);
